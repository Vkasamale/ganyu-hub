...
- **[BUG-017] The `payment_released` event is silently dropped — no record of when a creative was paid.** — found 2026-08-07 by a real sandbox release, payments/observability. **Schema fixed in repo; LIVE DB STILL NEEDS THE ALTER.**
