  ...
  return (
    <div className="mx-auto max-w-md px-4 py-16">
      <Card>
        ...
        <CardContent>
          <p className="mb-5 text-sm text-neutral-600">How will you use Ganyu Hub? You can&apos;t change this later, so pick the one that fits.</p>
          {error && (
          ...
          <div className="space-y-3">
            <form action={chooseRole}>
              ...
              <Button type="submit" variant="outline" className="h-auto w-full flex-col items-start gap-1 py-3 text-left">
                ...
                <span className="text-xs font-normal text-neutral-500">I want to show my work and get hired.</span>
              </Button>
            </form>
            <form action={chooseRole}>
              ...
              <Button type="submit" variant="outline" className="h-auto w-full flex-col items-start gap-1 py-3 text-left">
                ...
                <span className="text-xs font-normal text-neutral-500">I want to hire creatives for work.</span>
              </Button>
            </form>
          </div>
        </CardContent>
